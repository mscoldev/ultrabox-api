...
var getOriginById = /*#__PURE__*/function () {
  ...
  return function getOriginById() {
    return _ref2.apply(this, arguments);
  };
}();

var updateOriginById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 2;
            id = req.params.id;
            _req$body = req.body, originName = _req$body.originName, nit = _req$body.nit, enable = _req$body.enable;
            _context3.next = 7;
            return Origin.findByPk(id);

          case 7:
            originUpdated = _context3.sent;
...
module.exports = {
  ...
  updateOriginById: updateOriginById,
