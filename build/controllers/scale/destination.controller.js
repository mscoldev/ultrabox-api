...
var Destination = require('../../models/scale/destination.model');
...
var getDestinationById = /*#__PURE__*/function () {
  ...
  return function getDestinationById() {
    return _ref2.apply(this, arguments);
  };
}();

var updateDestinationById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 2;
            id = req.params.id;
            _req$body = req.body, name = _req$body.name, enable = _req$body.enable;
            _context3.next = 7;
            return Destination.findByPk(id);

          case 7:
            destinationUpdated = _context3.sent;
            ...
            _context3.next = 14;
            return destinationUpdated.save();
...
var createDestination = /*#__PURE__*/function () {
  ...
  return function createDestination() {
