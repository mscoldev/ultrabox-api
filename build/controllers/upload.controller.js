...
var storage = multer.diskStorage({
  destination: function destination(req, file, cb) {
    var _req$query = req.query,
        _req$query$app = _req$query.app,
        app = _req$query$app === void 0 ? "" : _req$query$app,
        _req$query$codeProjec = _req$query.codeProject,
        codeProject = _req$query$codeProjec === void 0 ? "" : _req$query$codeProjec;
    var uploadPath = path.join('uploads', 'files');
...
var storageMul = multer.diskStorage({
  destination: function destination(req, file, cb) {
    var _req$query2 = req.query,
        _req$query2$app = _req$query2.app,
        app = _req$query2$app === void 0 ? "" : _req$query2$app,
        _req$query2$codeProje = _req$query2.codeProject,
        codeProject = _req$query2$codeProje === void 0 ? "" : _req$query2$codeProje;
    var uploadPath = path.join('uploads', app, codeProject);
    fs.ensureDirSync(uploadPath);
    cb(null, uploadPath);
  },
  filename: function filename(req, file, cb) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 9:
              fileSaved = _context.sent;
              return _context.abrupt("return", res.status(200).send(fileSaved));
...
function _uploadFiles() {
  _uploadFiles = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var req,
        res,
        next,
        _args3 = arguments;
