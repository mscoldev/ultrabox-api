...
var Unit = require("../../models/tools/unit");
...
var createUnit = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _req$body = req.body, name = _req$body.name, symbol = _req$body.symbol;
            _context2.prev = 4;
            newUnit = new Unit({
              name: name,
              symbol: symbol
  ...
  return function createUnit() {
    return _ref2.apply(this, arguments);
  };
}();

var updateUnitById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _req$body2 = req.body, name = _req$body2.name, symbol = _req$body2.symbol;
            _context3.next = 8;
            return Unit.findByIdAndUpdate(_id, {
              name: name,
              symbol: symbol
            }, {
              "new": true
  ...
  return function updateUnitById() {
    return _ref3.apply(this, arguments);
  };
}();

var deleteUnitById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _id = Types.ObjectId(req.params._id);
            _context4.next = 7;
            return Unit.findByIdAndDelete(_id);

          case 7:
            deletedUnit = _context4.sent;
  ...
  return function deleteUnitById() {
